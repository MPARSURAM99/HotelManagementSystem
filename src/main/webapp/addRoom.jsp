...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="processAddRoom.jsp" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <label for="roomType">Category</label>
                    <select class="form-select" aria-label="Default select example" id="roomType" name="roomType" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" id="AC" name="AC">
                        <option selected>Open this select menu</option>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" id="Meal" name="Meal">
                        <option selected>Open this select menu</option>
                        <option value="1">Available</option>
                        <option value="2">NA</option>
                    </select>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" id="Couple" name="Couple">
                        <option selected>Open this select menu</option>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="status" name="status" value="Available"
                        required>
                </div>
